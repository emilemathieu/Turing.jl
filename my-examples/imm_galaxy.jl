...
#
# nb = 100
# gamma_samples = zeros(nb)
# # gamma_dis = Gamma(3, 18)
# gamma_dis = fit(Gamma, results[:s])
# for point in linspace(0,160,nb)
#     push!(gamma_samples, pdf(gamma_dis, point))
# end
# plot_histogram_with_truth(results[:s], 5000*gamma_samples[end-100:end])
# linescatter2(1000*gamma_samples[nb:end], linspace(0,160,nb))
